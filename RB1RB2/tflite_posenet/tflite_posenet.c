...
int main(int argc, char *argv[]) {
	...
	!gst_element_link_many (infqueue, qtimlvconverter, qtimltflite, qtimlvpose, NULL) ||
	!gst_element_link_filtered(qtimlvpose, qtimetamux, pad_filter) ||

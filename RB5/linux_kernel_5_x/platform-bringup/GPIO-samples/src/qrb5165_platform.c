...
int main(int argc, char* argv[])
{
    if (argc < 2 || strcmp(argv[1], "-help") == 0 || strcmp(argv[1], "-h") == 0) {
        printf("qrb5165_platform help:\n");
        printf("You can use like this:\n");
        printf("./qrb5165_platform -led user-led0_green 255\n");
        printf("./qrb5165_platform -button\n");
    ...
    if (!(strcmp(argv[1], "-led"))) {
        ...
        if (!(sscanf(argv[3], "%u", &led_brightness))) {
            ...
            printf("You can use like this:\n");
            printf("./qrb5165_platform -led user-led0_green 255\n");
            printf("./qrb5165_platform -pwm 1 1000 500\n");
        ...
        if (led_control(argv[2], led_brightness)) {
            ...
            printf("You can use like this:\n");
            printf("./qrb5165_platform -led user-led0_green 255\n");
            printf("./qrb5165_platform -gpio out 114 0\n");
            printf("./qrb5165_platform -irq 114\n");
        ...
        if (!(strcmp(argv[2], "out"))) {
            ...
            if (gpio_control(gpio_num, 1, &gpio_val)) {
                ...
                printf("You can use like this:\n");
                printf("./qrb5165_platform -gpio out 114 1\n");
        ...
        if (!(sscanf(argv[2], "%d", &thermal_number))) {
            ...
            printf("You can use like this:\n");
            printf("./qrb5165_platform -temp 0\n");
            return -1;
        }

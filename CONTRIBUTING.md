...
## Branching strategy
Contributors should develop on [their own fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) on branches based off of the `develop` branch and then pull requests should be made into the [upstream `develop` branch](https://github.com/quic/sample-apps-for-Qualcomm-Robotics-RB5-platform/tree/develop).

## Setup
Go to https://github.com/quic/sample-apps-for-Qualcomm-Robotics-RB5-platform and fork the repo using [these instructions](https://help.github.com/en/github/getting-started-with-github/fork-a-repo).
...
1. Go to your forked repo page `https://github.com/YOUR_USERNAME/sample-apps-for-Qualcomm-Robotics-RB5-platform` and click "New Pull Request".
1. Under "*compare changes*", select the base (destination) repository as `quic/sample-apps-for-Qualcomm-Robotics-RB5-platform` and the branch as `base:develop` to the left of the arrow.
1. Under "*compare changes*", select the head (source) repository as `YOUR_USERNAME/sample-apps-for-Qualcomm-Robotics-RB5-platform` and the branch as `base:branch_short_feature_description` to the right of the arrow.
